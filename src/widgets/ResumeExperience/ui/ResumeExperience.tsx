            ...
            <div className="relative border-l border-[#111111]/20 ml-3 pl-8 space-y-12 md:space-y-16">
                ...
                {experiences.map((exp) => (
                    <div key={exp.id} className="relative group">
                        ...
                        <div className="absolute left-[-50.5px] flex h-8 w-8 items-center justify-center rounded-full border border-[#111111] bg-[#F7F7F5] text-[#111111] transition-colors duration-300 group-hover:bg-[#111111] group-hover:text-[#F7F7F5]">
                            {exp.icon}
                        </div>
